  ...
  return (
    <Container>
      <section className="benefits">
        <h1 className="benefits__title">Чому ми?</h1>
        <div className="benefits__row">
          <div className="benefits__column__image__container">
        ...
        <div className="benefits__row">
          <div className="benefits__column">
            <p className="benefits__column__text">
              ...
              Це означає, що ми можемо створювати унікальну паковальну продукцію для ринку харчової промисловості і
            ...
            <Button title="Оформити замовлення" background="var(--secondary)" width="50%" fontSize="1.1rem" />
          </div>
